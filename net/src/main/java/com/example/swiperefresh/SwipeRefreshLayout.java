...
public class SwipeRefreshLayout extends ViewGroup {
    ...
    //涔嬪墠鎵嬪娍鐨勬柟鍚戯紝涓轰簡瑙ｅ喅鍚屼竴涓Е鐐瑰墠鍚庣Щ鍔ㄦ柟鍚戜笉鍚屽鑷村悗涓�涓柟鍚戜細鍒锋柊鐨勯棶棰橈紝
    //杩欓噷Mode.DISABLED鏃犳剰涔夛紝鍙槸涓�涓垵濮嬪�硷紝鍜屼笂鎷�/涓嬫媺鏂瑰悜杩涜鍖哄垎
    private Mode mLastDirection = Mode.DISABLED;
    private int mDirection = 0;
    //褰撳瓙鎺т欢绉诲姩鍒板敖澶存椂鎵嶅紑濮嬭绠楀垵濮嬬偣鐨勪綅缃�
    private float mStartPoint;
    private boolean up;
    private boolean down;
    //鏁版嵁涓嶈冻涓�灞忔椂鏄惁鎵撳紑涓婃媺鍔犺浇妯″紡
    ...
    private final Animation mAnimateToStartPosition = new Animation() {
        ...
        public void applyTransformation(float interpolatedTime, Transformation t) {
            ...
            //娉ㄩ噴鎺夎繖閲岋紝涓嶇劧涓婃媺鍚庡洖澶嶅師浣嶇疆浼氬緢蹇紝涓嶅钩婊�
...
//            }
    ...
    public void setOnRefreshListener(OnRefreshListener listener) {
    	Log.i("RESlistener", ""+listener);
        mRefreshListener = listener;
    }

    public void setOnLoadListener(OnLoadListener listener) {
    	Log.i("LOAlistener", ""+listener);
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        ...
        switch (action) {
            case MotionEvent.ACTION_DOWN:
                ...
                //杩欓噷鐢╱p/down璁板綍瀛愭帶浠惰兘鍚︿笅鎷夛紝濡傛灉褰撳墠瀛愭帶浠朵笉鑳戒笂涓嬫粦鍔紝浣嗗綋鎵嬫寚鎸変笅骞剁Щ鍔ㄥ瓙鎺т欢鏃讹紝鎺т欢灏变細鍙樺緱鍙粦鍔�
                //鍚庨潰鐨勪竴浜涘鐞嗕笉鑳界洿鎺ヤ娇鐢╟anChildScrollUp/canChildScrollDown
                //浣嗕粛瀛樺湪闂锛氬綋鏁版嵁涓嶆弧涓�灞忎笖璁剧疆鍙互涓婃媺妯″紡鍚庯紝澶氭蹇�熶笂鎷変細婵�鍙戜笂鎷夊姞杞�
                up = canChildScrollUp();
...
//                final float yDiff = y - mInitialMotionY;
                ...
                //鑻ヤ笂涓墜鍔跨殑鏂瑰悜鍜屽綋鍓嶆墜鍔挎柟鍚戜笉涓�鑷达紝杩斿洖
                if((mLastDirection == Mode.PULL_FROM_START && yDiff < 0) ||
                		(mLastDirection == Mode.PULL_FROM_END && yDiff > 0))
                {
                	return false;
                }
                //涓嬫媺鎴栦笂鎷夋椂锛屽瓙鎺т欢鏈韩鑳藉婊戝姩鏃讹紝璁板綍褰撳墠鎵嬫寚浣嶇疆锛屽綋鍏舵粦鍔ㄥ埌灏藉ご鏃讹紝
                //mStartPoint浣滀负涓嬫媺鍒锋柊鎴栦笂鎷夊姞杞界殑鎵嬪娍璧风偣
                ...
                if (yDiff > mTouchSlop)
                {
                	//鑻ュ綋鍓嶅瓙鎺т欢鑳藉悜涓嬫粦鍔紝鎴栬�呬笂涓墜鍔夸负涓婃媺锛屽垯杩斿洖
                ...
                //涓婃媺
                	...
                	//鑻ュ綋鍓嶅瓙鎺т欢鑳藉悜涓婃粦鍔紝鎴栬�呬笂涓墜鍔夸负涓嬫媺锛屽垯杩斿洖
                	if (canChildScrollDown() || mLastDirection == Mode.PULL_FROM_START)
					{
                		mIsBeingDragged = false;
						return false;
					}
                	//鑻ュ瓙鎺т欢涓嶈兘涓婁笅婊戝姩锛岃鏄庢暟鎹笉瓒充竴灞忥紝鑻ヤ笉婊″睆涓嶅姞杞斤紝杩斿洖
